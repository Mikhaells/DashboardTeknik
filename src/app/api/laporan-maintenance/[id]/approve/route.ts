...
import { FeedbackRequest } from '@/types/laporan-maintenance';
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Laporan maintenance berhasil disetujui',
    });

  } catch (error) {
    console.error('Error approving laporan maintenance:', error);
    return NextResponse.json(
      {
        success: false,
