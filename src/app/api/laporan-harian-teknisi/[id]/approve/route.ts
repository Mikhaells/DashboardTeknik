...
/**
 * API Route: POST /api/laporan-harian-teknisi/[id]/approve
 * 
 * Handles approving laporan harian teknisi
 */
export async function POST(
  ...
  try {
    ...
    console.error('Error approving laporan harian teknisi:', error);
    return NextResponse.json(
      {
        success: false,
