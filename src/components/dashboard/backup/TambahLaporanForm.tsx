    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-10 mx-auto p-5 border w-full max-w-5xl shadow-lg rounded-xl bg-white" style={{ maxHeight: '90vh', overflowY: 'auto' }}>
        ...
        <form id="tdForm" onSubmit={handleSubmit}>
          ...
          {/* E. GANGGUAN/KENDALA TEKNIS */}
          <div className="mb-8">
            <h3 className="text-sm font-bold bg-blue-50 text-blue-900 px-4 py-2 rounded mb-2">E. GANGGUAN / KENDALA TEKNIS</h3>
          ...
          {/* G. CATATAN KHUSUS / REKOMENDASI */}
          <div className="mb-8">
            <h3 className="text-sm font-bold bg-blue-50 text-blue-900 px-4 py-2 rounded mb-2">G. CATATAN KHUSUS / REKOMENDASI</h3>
